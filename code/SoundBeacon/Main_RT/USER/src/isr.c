...
{
  if(LPUART_GetStatusFlags(LPUART5))
  {
...
{
  if(LPUART_GetStatusFlags(LPUART1))
  {
...
{
  if(LPUART_GetStatusFlags(LPUART6))
  {
    LPUART_ClearStatusFlags(LPUART6,kLPUART_RxDataRegFullFlag);
...
{
  if(LPUART_GetStatusFlags(LPUART8))
  {
    LPUART_ClearStatusFlags(LPUART8,kLPUART_RxDataRegFullFlag);
