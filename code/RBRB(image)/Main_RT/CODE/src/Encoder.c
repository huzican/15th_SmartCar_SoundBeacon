...
void speed_get()
{
  motor.speed_F_L = qtimer_quad_get(F_L_QTIMER, F_L_ENCODER_PHASE_A);
  motor.speed_F_R = qtimer_quad_get(F_R_QTIMER, F_R_ENCODER_PHASE_A);
  motor.speed_B_L = qtimer_quad_get(B_L_QTIMER, B_L_ENCODER_PHASE_A);
  motor.speed_B_R = qtimer_quad_get(B_R_QTIMER, B_R_ENCODER_PHASE_A);
